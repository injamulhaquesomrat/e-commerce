      ...
      <div className="max-w-[1390px] mx-auto">
        <div className="px-4 py-6 flex items-center justify-between">
              ...
              <li className="ml-2 lg:ml-4 relative inline-block p-2 hover:scale-110 duration-200">
                ...
                >
                  ...
                  <SheetContent className="p-0">
                    <SheetHeader className="px-4 py-6 bg-secondary flex-row lg:flex-row-reverse space-y-0 justify-between">
                      <button
                        onClick={() => setIsCategoryOpen(false)}
                        className="flex justify-center items-center"
                      >
                        <FaArrowLeftLong className="lg:rotate-180" size={20} />
                      </button>
          ...
          <div className="lg:hidden space-x-4">
            ...
            <Sheet
              open={isOpenNav}
              onOpenChange={() => setIsOpenNav(!isOpenNav)}
            >
              <SheetTrigger>
                <IndentDecrease className="size-6" />
              </SheetTrigger>
            ...
            <ul className="flex items-center justify-end">
              {navItems.slice(0, 5).map((item) => (
                <Link key={item.id} className="" href={item.link}>
                  <li className="font-medium px-6 py-4 hover:text-primary duration-300 text-sm">
                    {item.name}
                  </li>
                </Link>
              ))}
